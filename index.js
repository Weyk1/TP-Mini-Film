let cardapi = document.querySelector(".container");
...
async function getMovies() {
  ...
  const data = getMovies().then(function (movies) {
    ...
    movies.forEach(function (movie) {
      ...
      cardbutton.innerHTML = '<button type="button" class="btn btn-outline-danger">VOIR PLUS</button>'
      cardBody.appendChild(cardbutton)

      cardapi.appendChild(card)
    })
  })